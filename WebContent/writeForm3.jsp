                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            <div class="form-top">
	                            ...
	                            <div class="form-bottom">
	                                <form name="writeForm" role="form" action="writePro3.jsp" method="post" class="form-horizontal">
	                                  ...
	                                  <div class="form-group">
	                                   ...
	                                   <table class="table table-striped ">
											...
											<td>
												...
												<td>
												<input name="writer" type="text" placeholder="이름...">
												</td></tr>
												
												<tr><td><div align="center">E-mail</div></td>
												<td><input name="email" type="text"  placeholder="메일..."/>
												</td>												
											...
											<tr>
												...
												<td>
												<input name="passwd" type="password"  placeholder="패스워드..."/>
												</td>
											</tr>
											...
											<div align="center">content</div>
												...
												<td>
									<textarea name="content"  rows="10" cols="100" style="width:500px; height:420px;"></textarea>
