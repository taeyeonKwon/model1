                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
							...
							<div class="form-bottom">
	                                <form method="POST" name="delForm"  action="delPro2.jsp?pageNum=<%=pageNum%>" class="form-horizontal">
	                                  <div class="form-group">
										 ...
										 <tr height="30">
										    <td align=center>
										      ...
										      <a class="btn btn-default" href="document.location.href='boardlist2.jsp?pageNum=<%=pageNum%>'">글목록</a>     
										   </td>
										 </tr>  
											</table> 
											</div>
