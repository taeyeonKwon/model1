...
<% int num = Integer.parseInt(request.getParameter("num"));
   ...
   try{QnaDBBean dbPro = QnaDBBean.getInstance();
   QnaDataBean article = dbPro.getArticleUpdate(num);
   %>
<html>
<head>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            <div class="form-top">
	                            ...
	                            <div class="form-bottom">
	                               <form name="update" role="form" action="updatePro3.jsp" method="post" class="form-horizontal">
	                                  ...
	                                  <div class="form-group">
	                                   <table class="table table-striped" >
											...
											<tr><td>
												...
												<td><input name="email" type="text" value = "<%=article.getEmail() %>"></td></tr>
