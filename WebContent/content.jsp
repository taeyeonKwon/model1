	                                   ...
	                                   <table class="table table-striped" >
											...
											<tr height="30">
														<td colspan="4" align="right">
															<input type="button" class="btn btn-default" value="글수정" onclick="document.location.href='update.jsp?num=<%=article.getNum()%>&pageNum=<%=pageNum%>'">&nbsp;&nbsp;&nbsp;&nbsp;
															<input type="button" class="btn btn-default" value="글삭제" onclick="document.location.href='deleteForm.jsp?num=<%=article.getNum()%>&pageNum=<%=pageNum%>'">&nbsp;&nbsp;&nbsp;&nbsp;
										...
										--%>					
															<input type="button" class="btn btn-default" value="글목록" onclick="document.location.href='boardlist.jsp?num=<%=article.getNum()%>&pageNum<%=pageNum%>'">&nbsp;&nbsp;&nbsp;&nbsp;
