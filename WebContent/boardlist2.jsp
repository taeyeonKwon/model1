<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
<%@page import="kwon_bean2.BoardDataBean2"%>
<%@page import="kwon_bean2.BoardDBBean02"%>
...
<%
	...
	BoardDBBean02 dbPro = BoardDBBean02.getInstance();
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="box">
						...
						<span class="label label-default">FAQ</span></h3>
                                ...
                                <div class="board">
                                    <div class="boardlist2" id="board_list2">
										...
										<% for(int i=0; i<articleList.size(); i++){
											BoardDataBean2 article = (BoardDataBean2)articleList.get(i);
											%> 
										 <tr height="30">
										...
										<img src="<%=request.getContextPath()%>/img/hot.gif" border="0" height="16"> 
                                             ...
                                             <a href="content2.jsp?num=<%=article.getNum()%>&pageNum=<%=currentPage%>"><%=article.getSubject() %></a>
                                    ...
                                    <div class="list_footer paddint-right">
                                        <div class="btnArea">
                                            <div class="row">
                                                <div class="col-md-1">
                                                    <a href="boardlist2.jsp?pageNum=<%=startPage-10%>"> 
													...
													%>
                                                <div class="col-md-2">
                                                   <a href="boardlist2.jsp?pageNum<%=i%>">[<%=i%>]</a>
                                                </div>
                                                <%
													 }
												...
												%>
                                               <div class="col-md-1">
                                               <a href="baordlist02.jsp?pageNum=<%=startPage+10%>">
                                               <span class="direction next"></span>뒤 페이지&nbsp;
                                                ...
                                                <div class="col-md-3">
                                                    <form action="writeForm2.jsp" method="post">
