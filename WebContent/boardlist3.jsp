                ...
                <div class="row">
                    <div class="box">
                        <div class="col-lg-12 padding-top-10">
						  ...
						  <a class="btn btn-info" href="boardlist3.jsp?boardId=1">QnA</a>	
						  <!-- <a class="btn btn-info" href="boardlist3.jsp?boardId=2">클래스 후기</a> -->	
						</div>
						<span class="label label-default">QnA 무엇이든 물어보세요</span></h3>
                ...
                <div class="row">
                    <div class="box">
                        <div class="col-lg-12">
                            <div>
                                <div class="board">
                                    <div class="boardlist2" id="board_list2">
                                        ...
                                        cellspacing="0" summary="List of Articles">
										 ...
										 <%for(int i=0; i<articleList.size(); i++){
												QnaDataBean article =(QnaDataBean)articleList.get(i); 
												 %>
										 <tr height="30">
										<td align="center" width="50" ><%-- <%=i%>: --%><%=number--%></td>
										<td width="250">
										 <% 
										 	int wid =0;
										 ...
										 width ="<%=wid %>" height ="16">
                                             ...
                                             <a href="content3.jsp?num=<%=article.getNum()%>&pageNum=<%=currentPage%>"><%=article.getSubject() %></a>
                                    ...
                                    <div class="list_footer paddint-right">
                                        <div class="btnArea">
                                            <div class="row">
                                                <div class="col-md-1">
                                                    <a href="boardlist3.jsp?pageNum=<%=startPage-10%>"> 
                                                    <span class="glyphicon glyphicon-triangle-left"></span>&nbsp;앞 페이지</a>
                                                </div>
											                                                <%
														}
													...
													%>
                                                <div class="col-md-2">
                                                   <a href="boardlist3.jsp?pageNum<%=i%>">[<%=i%>]</a>
                                                </div>
                                                <%
													 }
												...
												%>
                                               <div class="col-md-1">
                                               <a href="baordlist03.jsp?pageNum=<%=startPage+10%>">
                                               <span class="direction next"></span>뒤 페이지&nbsp;
                                               </a>
		                                        <%
														}
													}
                                                ...
                                                <div class="col-md-3">
                                                    <form action="writeForm3.jsp" method="post">
