...
try{
	...
	BoardDataBean2 article = dbpro.getArticle(num); 
                            ...
                            <div class="form-top">
	                            ...
	                            <div class="form-bottom">
	                                <form nrole="form"  class="form-horizontal">
	                                   ...
	                                   <table class="table table-striped" >
											...
											<tr height="30">
														<td colspan="4" align="right">
															<input type="button" class="btn btn-default" value="글수정" 	onclick="document.location.href='update2.jsp?num=<%=article.getNum()%>&pageNum=<%=pageNum%>'">&nbsp;&nbsp;&nbsp;&nbsp;
															<input type="button" class="btn btn-default" value="글삭제" 	onclick="document.location.href='deleteForm2.jsp?num=<%=article.getNum()%>&pageNum=<%=pageNum%>'">&nbsp;&nbsp;&nbsp;&nbsp;
										...
										--%>					
															...
															onclick="document.location.href='boardlist2.jsp?num=<%=article.getNum()%>&pageNum<%=pageNum%>'">&nbsp;&nbsp;&nbsp;&nbsp;
	                                 ...
	                                 <div class="row">
                   					 <!-- 라이브리 시티 설치 코드 -->
										<div id="lv-container" data-id="city" data-uid="MTAyMC8yNDcyNy8xNTEx">
