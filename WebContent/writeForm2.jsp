...
function inputCheck(){
	...
	if(document.writeForm2.writer.value==""||document.writeForm2.writer.value==null){
		alert("이름을 입력하세요.");
		document.writeForm2.writer.focus();
		return false;
	}if(document.writeForm2.passwd.value==""||document.writeForm2.passwd.value==null){
		alert("비밀번호를  입력하세요.");
		document.writeForm2.passwd.focus();
		return false;
	}if(document.writeForm2.subject.value==""||document.writeForm2.subject.value==null){
		alert("제목을 입력하세요.");
		document.writeForm2.subject.focus();
		return false;
	}if(document.writeForm2.content.value==""||document.writeForm2.content.value==null){
		alert("내용을 입력하세요.");
		document.writeForm2.content.focus();
		return false;
	/* }if(document.kwonForm.sexual.value=="""){
		alert("성별을 선택하세요.");
		userinput.sexual.focus();
		return false; */
	}
}
</script>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            <div class="form-top">
	                            ...
	                            <div class="form-bottom">
	                                <form name="writeForm2" role="form" action="writePro2.jsp" method="post" 
	                                class="form-horizontal" onsubmit="return inputCheck()">
	                                   ...
	                                   <table class="table table-striped ">
											<tr><td>
												...
												<td><%-- <%=session.getAttribute("id") %> --%>
												 <input name="writer" type="text" placeholder="이름..."> </tr>
