...
<% int num = Integer.parseInt(request.getParameter("num"));
   ...
   try{BoardDBBean dbPro = BoardDBBean.getInstance();
   BoardDataBean article = dbPro.getArticleUpdate(num);
   %>
<html>
<head>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            <div class="form-top">
	                            ...
	                            <div class="form-bottom">
	                               <form name="update" role="form" action="updatePro.jsp" method="post" class="form-horizontal">
